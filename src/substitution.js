...
const decypher = (str, key1, key2) => {
  ...
  const resultArr = arr.map(letter => {
    const frequencyIndex = key1.findIndex(item => 
      item[ 0 ].includes(letter)
    );
...
const createKeyForCzech = () => {
  const obj = { 'a': 134675829, 'c': 42120335, 'b': 24944593, 'e': 153141622, 'd': 53015496, 'g': 3087128, 'f': 2458624, 'i': 93903002, 'h': 35075708, 'k': 49549907, 'j': 32383080, 'm': 50636489, 'l': 80345129, 'o': 112776769, 'n': 83104322, 'q': 83322, 'p': 43747863, 's': 78451777, 'r': 61750942, 'u': 50265458, 't': 75633324, 'w': 762129, 'v': 55510103, 'y': 40132126, 'x': 504334, 'z': 46383740 };
