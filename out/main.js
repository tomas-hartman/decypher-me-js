class DecypherMe {
    constructor(obj) {
        this.prepareInput = (string) => {
            string = string.toLowerCase();
            string = string.replace(/\W/g, "");
            return string;
        };
        this.prepareOutput = (string) => {
        ...
        this.encodeToNums = (stringToEncode, decypheringTable) => {
        ...
        this.encodeToLetters = (stringToEncode, decypheringTable) => {
            let output = "";
         ...
         */
        this.encode = (stringToEncode, decypheringTable) => {
        ...
        this.decode = (stringToDecode, decypheringTable) => {
